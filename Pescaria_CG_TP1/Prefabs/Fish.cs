...
namespace Pescaria_CG_TP1.Prefabs {
	public class Fish {
		...
		private static AnimationClip GetAnimationClip (int animationIdx, GameObject fish) {
			...
			switch (animationIdx) {
				case 0:
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(300, Transform.DISABLE_AXIS_MOVIMENT, 400, 0, 100, 0));
				...
				case 1:
					...
					animationClip.AddClipPoint(4000, "FISH3_SWIM_RIGHT", new Vector2(300, fish.Transform.Position.Y + 400, 400, 0, 100, 0), () => {
				...
				case 2:
					...
					animationClip.AddClipPoint(100, "FISH3_SWIM_RIGHT", new Vector2(0, fish.Transform.Position.Y));
					animationClip.AddClipPoint(3000, "FISH3_SWIM_RIGHT", new Vector2(300, fish.Transform.Position.Y - 400, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 22;
					});
					animationClip.AddClipPoint(3000, "FISH3_SWIM_LEFT", new Vector2(0, fish.Transform.Position.Y));
					break;
				case 3:
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(300, fish.Transform.Position.Y + 300, 400, 400, 100, 100), () => {
						fish.Transform.Position.X = SceneManager.ScreenSize.X - 100;
						fish.Transform.Rotation = 90;
					});

					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(0, fish.Transform.Position.Y + 300, 400, 400, 100, 100), () => {
						fish.Transform.Rotation = 0;
					});

					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(0, fish.Transform.Position.Y + 75, 400, 400, 100, 100), () => {
						fish.Transform.Rotation = 90;
					});

					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(300, fish.Transform.Position.Y + 75, 400, 400, 100, 100), () => {
						fish.Transform.Rotation = 0;
					});
					break;
				case 4:
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(0, fish.Transform.Position.Y, 400, 0, 100, 0));
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(100, fish.Transform.Position.Y + 100, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = -30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(200, fish.Transform.Position.Y, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(300, fish.Transform.Position.Y + 100, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = -30;
					});
					animationClip.AddClipPoint(2000);
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(200, fish.Transform.Position.Y, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = -30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(100, fish.Transform.Position.Y + 100, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(0, fish.Transform.Position.Y, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = -30;
					...
					break;
				default:
					animationClip.AddClipPoint(100, "FISH3_SWIM_RIGHT", new Vector2(300, fish.Transform.Position.Y), () => {
						fish.Transform.Position.X = 300;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(300, fish.Transform.Position.Y, 400, 0, 100, 0));
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(200, fish.Transform.Position.Y + 100, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(100, fish.Transform.Position.Y, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = -30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_LEFT", new Vector2(0, fish.Transform.Position.Y + 100, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 30;
					});
					animationClip.AddClipPoint(2000);
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(100, fish.Transform.Position.Y, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(200, fish.Transform.Position.Y + 100, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = -30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT", new Vector2(300, fish.Transform.Position.Y, 400, 0, 100, 0), () => {
						fish.Transform.Rotation = 30;
					});
					animationClip.AddClipPoint(2000, "FISH3_SWIM_RIGHT");
					break;
			}
